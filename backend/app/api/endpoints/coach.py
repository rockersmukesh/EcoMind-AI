...
def get_recommendations(profile: CarbonProfileInput):
    ...
    try:
        ...
        recommendations = GeminiCoachService.get_sustainability_recommendations(calculated_profile)
...
def simulate_changes(payload: SimulationRequest):
    ...
    try:
        ...
        feedback = GeminiCoachService.get_simulation_feedback(current_calc, simulated_calc)
